            ...
            div.innerHTML += `
                <div class="card" style="width: 18rem;">
                    <div class="card-body">
                        ...
                        <div class="card-subtitle text-body-secondary">Maior Valor: R$ ${moeda.high}</div>
                        <div class="card-subtitle text-body-secondary">Menor Valor: R$ ${moeda.low}</div>
                        <div class="card-subtitle text-body-secondary"><span class="aovivo"></span> Oferta de Compra: R$ ${moeda.bid}</div>
                        <div class="card-subtitle text-body-secondary"><span class="aovivo"></span> Oferta de venda: R$ ${moeda.ask}</div>
                    </div>
                </div>    
            `;
        };
